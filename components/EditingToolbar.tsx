    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-2 flex items-center space-x-2" role="toolbar" aria-label="Image editing tools">
            <div className="flex items-center gap-2 pr-2">
                {tools.map((tool) => (
                    <button 
                        ...
                        className="flex flex-col items-center justify-center text-zinc-600 hover:text-orange-600 transition-colors duration-200 w-16 h-14 rounded-lg hover:bg-zinc-100 focus:outline-none focus:bg-zinc-100 focus:ring-2 focus:ring-orange-500"
                    >
            ...
            <button 
              ...
              className="w-12 h-12 flex-shrink-0 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center hover:bg-orange-200 transition-colors duration-200 ml-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
