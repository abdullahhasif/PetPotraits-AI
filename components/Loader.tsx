...
const Loader: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center p-8 bg-white/60 backdrop-blur-sm rounded-2xl">
            <svg
            ...
            <p className="mt-4 text-lg font-semibold text-orange-800 transition-opacity duration-500">
                {message}
            </p>
        </div>
    );
